          ...
          <div className="container mx-auto px-6 max-w-3xl">
            <motion.div {...fadeIn}>
              ...
              <Accordion type="single" collapsible className="space-y-4">
                {[
                  { q: "Combien coûte une isolation phonique à Paris ?", a: "Le prix d'une isolation phonique à Paris varie de 50 à 150 €/m² selon la technique utilisée et la surface à traiter. Un doublage acoustique de mur coûte en moyenne 80 à 120 €/m², tandis qu'un faux plafond acoustique se situe entre 70 et 130 €/m². Harmonie BTP propose un devis gratuit et détaillé sous 24h." },
