...
const IsolationPage = () => {
  return (
    <>
      ...
      <title>Isolation phonique et acoustique | Spécialiste isolation | Harmonie</title>
      <meta name="description" content="Spécialistes des travaux d'isolation phonique et acoustique. Experts en isolation thermique. Diagnostic, matériaux performants et pose professionnelle pour votre confort." />
      ...
      <main className="min-h-screen bg-background">
          ...
          <div className="relative z-10 container mx-auto px-6 text-center">
            <motion.div {...fadeIn}>
              ...
              <p className="text-lg md:text-xl text-primary-foreground/80 max-w-3xl mx-auto font-light leading-relaxed">
                Experts en travaux d'isolation phonique, isolation acoustique et isolation thermique.
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div {...fadeIn}>
                ...
                <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">
                  Pourquoi réaliser des travaux d'isolation phonique et thermique ?
                </h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  confort optimal, tant acoustique que thermique, grâce à des matériaux performants et une
                  pose irréprochable.
                </p>
              </motion.div>
              <motion.div {...fadeIn} className="relative">
                <img
                  src={confortImg}
                  alt="Intérieur confortable grâce aux travaux d'isolation phonique et thermique"
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-6">
            <motion.div {...fadeIn} className="text-center mb-16">
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">
                Avantages des travaux d'isolation acoustique et thermique
              </h2>
            </motion.div>
        ...
        <section className="py-20 bg-secondary">
          <div className="container mx-auto px-6">
            <motion.div {...fadeIn} className="text-center mb-16">
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">
                Travaux d'isolation phonique et thermique par zone
              </h2>
            </motion.div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto">
              <motion.div {...fadeIn} className="text-center mb-12">
                ...
                <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">
                  Tout savoir sur les travaux d'isolation phonique et thermique
                </h2>
              </motion.div>
        ...
        {/* Isolation Thermique - Section détaillée (en bas) */}
        <section className="py-20 bg-secondary">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <motion.div {...fadeIn}>
          ...
          <div className="container mx-auto px-6 text-center">
            <motion.div {...fadeIn}>
              <h2 className="font-serif text-3xl md:text-4xl text-primary-foreground mb-6">
                Besoin de travaux d'isolation phonique ou thermique ?
              </h2>
              <p className="text-primary-foreground/70 max-w-2xl mx-auto mb-8 text-lg">
                ...
                d'<strong>isolation phonique</strong> et <strong>isolation thermique</strong> les plus
